...
var (
	...
	MainnetChainConfig = &ChainConfig{
		ChainID: big.NewInt(686868), // set athena chain id
		...
		AnatoliaBlock:       big.NewInt(25_228_800),
	...
	AllEthashProtocolChanges = &ChainConfig{big.NewInt(1337), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, nil, false, new(EthashConfig), nil}
	...
	TestChainConfig = &ChainConfig{big.NewInt(1), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, nil, false, new(EthashConfig), nil}
...
type ChainConfig struct {
	...
	AnatoliaBlock       *big.Int `json:"dubaiBlock,omitempty"`          // Anatolia switch block (nil = no fork, 0 = already on anatolia)
...
// IsAnatolia returns whether num is either equal to the Anatolia fork block or greater.
func (c *ChainConfig) IsAnatolia(num *big.Int) bool {
	return isForked(c.AnatoliaBlock, num)
}
...
func (c *ChainConfig) CheckConfigForkOrder() error {
	...
	for _, cur := range []fork{
		...
		{name: "anatoliaBlock", block: c.AnatoliaBlock},
	} {
		if lastFork.name != "" {
...
func (c *ChainConfig) checkCompatible(newcfg *ChainConfig, head *big.Int) *ConfigCompatError {
	...
	if isForkIncompatible(c.AnatoliaBlock, newcfg.AnatoliaBlock, head) {
		return newCompatError("Anatolia fork block", c.AnatoliaBlock, newcfg.AnatoliaBlock)
	}
	return nil
}
