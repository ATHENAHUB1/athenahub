...
func DefaultGenesisBlock() *Genesis {
	return &Genesis{
		...
		Nonce:      66,
		ExtraData:  hexutil.MustDecode("0x48656c6c6f20417468656e61"),
		GasLimit:   30000000,           // set the default gasLimit to fit the wallet
		Difficulty: big.NewInt(136756), // set the starting difficulty
