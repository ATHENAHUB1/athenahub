...
func (c *Config) NodeName() string {
	...
	if name == "athena" || name == "athena-testnet" {
		name = "athena"
	}
	if c.UserIdent != "" {
		name += "/" + c.UserIdent
...
func (c *Config) StaticNodes() []*enode.Node {
	nodes := c.parsePersistentNodes(&c.staticNodesWarning, c.ResolvePath(datadirStaticNodes))
	return append(c.loadPersistentNodes(params.MainnetBootnodes), nodes...)
}

// TrustedNodes returns a list of node enode URLs configured as trusted nodes.
func (c *Config) TrustedNodes() []*enode.Node {
	nodes := c.parsePersistentNodes(&c.trustedNodesWarning, c.ResolvePath(datadirTrustedNodes))
	return append(c.loadPersistentNodes(params.MainnetBootnodes), nodes...)
}
...
// loadPersistentNodes parses a list of discovery node URLs from boot nodes.
func (c *Config) loadPersistentNodes(enodes []string) []*enode.Node {
	// Interpret the list as a discovery node array
	var nodes []*enode.Node
